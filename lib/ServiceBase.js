module.exports = function(app, options) {
    ...
    app.get(resource + '/:shop_id', get, function(req, res) {
        res.send(req[name]);
    });
    ...
    app.post(resource + '/:shop_id', put, function(req, res) {
        res.send({ok: 1});
    });

    app.put(resource + '/:shop_id', put, function(req, res) {
        res.send({ok: 1});
    });

    app.del(resource + '/:shop_id', del, function(req, res) {
        res.send({ok: 1});
    });
}