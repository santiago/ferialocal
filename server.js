...
app.get('/', function(req, res) {
	res.render('index', {
		    categories: ['Accesorios y Objetos','Gastronomía y Productos Comestibles','Marroquinería y Calzado','Vestuario', 'Joyería', 'Servicios', 'Otros'],
...
// Start Services
app.services = {};
['Shop','Comment'].forEach(function(name) {
